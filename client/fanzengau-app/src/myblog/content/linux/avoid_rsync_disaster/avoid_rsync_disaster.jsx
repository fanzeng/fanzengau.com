    ...
    <>
      ...
      <div className="section">
        ...
        <p>
          ...
          It's too often that people accidentally delete the good copies when their intention is to delete the messed-up ones instead.
        </p>
        ...
        <p>
          The test directory is reset to its initial status after each run of rsync.
        ...
        <p>
          ...
          whereas when there is a trailing slash at the end of src, rsync will sync the contents of src and place them
